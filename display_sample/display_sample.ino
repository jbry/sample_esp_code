...
void setup(void) {
  ...
  // This can use constantants, or values 0-3 depending on orientation.
  // KEEP THE SECOND ARGUMENT "true" or everything will be backwards
  tft.setRotation(ST77XX_ROTATE_RIGHT,true);
